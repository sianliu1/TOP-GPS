...
class AnalysisOptions(QWidget):
    def __init__(self, vis_page=False):
        ...
        self.unit = QtO.new_combo(["碌m", "mm"], 120, connect=self.update_units)
        ...
        self.maxRadius = QtO.new_spinbox(150, 500, 150, "Left", suffix=" 碌m")
        ...
        self.isoResolution = QtO.new_doublespin(
            0.01, 100, 1, 100, suffix=" 碌m\u00B3", decimals=2
        )
        ...
        self.anisoZ = QtO.new_doublespin(
            0.01, 100, 1, width=80, suffix=" 碌m\u00B3", decimals=2
        )
        QtO.add_widgets(
        ...
        self.filterSize = QtO.new_doublespin(0.01, 1000, 10, width=100, suffix=" 碌m")
        ...
        self.pruneSize = QtO.new_doublespin(0.01, 1000, 5, width=100, suffix=" 碌m")
