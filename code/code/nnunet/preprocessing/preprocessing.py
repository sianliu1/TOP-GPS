...
class GenericPreprocessor(object):
    ...
    def preprocess_test_case_itk(self, data_itk, target_spacing, seg_itk=None, force_separate_z=None):
        data, seg, properties = ImageCropper.crop_from_itk_imgs(data_itk, seg_itk)
